...
QT_MOC_LITERAL(8, 90, 3) // "loc"
    ...
    "WorkerThread\0progressChanged\0\0info\0"
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkerThread::progressChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (WorkerThread::*_t)(int , char * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkerThread::progressShortestPath)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void WorkerThread::progressChanged(int _t1)
{
...
// SIGNAL 1
void WorkerThread::progressShortestPath(int _t1, char * _t2)
{
